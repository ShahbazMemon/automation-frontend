...
import {
  oilProduction,
  booksSale
} from "./demo-data/data-vizualization";
...
// const series = [
//   { name: 'mysteries', key: 'mysteries', color: '#08abbd' },
//   { name: 'scienceFiction', key: 'scienceFiction', color: '#78bc97' },
//   { name: 'romance', key: 'romance', color: '#d4d67e' },
//   { name: 'fantasy', key: 'fantasy', color: '#9ccc65' },
//   { name: 'thrillers', key: 'thrillers', color: '#1698af' }
// ];
const series = [
...
const modifyOilDomain = (domain) => [domain[0], 1200];
const modifyPriceDomain = () => [0, 1800];
